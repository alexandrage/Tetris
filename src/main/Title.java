...
public class Title extends JPanel implements MouseListener, MouseMotionListener {
	...
	public Title(Window window) {
		try {
			...
			instructions = ImageIO.read(Board.class.getResource("/assets/arrow.png"));
			play = ImageIO.read(Board.class.getResource("/assets/play.png"));
		} catch (IOException e) {
			e.printStackTrace();
		}
		...
		bounds = new Rectangle(Window.WIDTH / 2 - 40, Window.HEIGHT / 2 - 70, 100, 80);
		this.window = window;
	...
	public void paintComponent(Graphics g) {
		...
		g.drawImage(title, Window.WIDTH / 2 - title.getWidth() / 2, Window.HEIGHT / 2 - title.getHeight() / 2 - 200,
				null);
